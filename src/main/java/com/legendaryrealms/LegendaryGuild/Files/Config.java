...
public class Config extends FileProvider{
    ...
    // 指令配置相关字段
    public boolean ENABLE_CUSTOM_ALIASES;
    public String MAIN_COMMAND;
    ...
    public void readDefault() {
        ...
        // 读取指令配置
        ENABLE_CUSTOM_ALIASES = getValue("commands.enable_custom_aliases", true);
        MAIN_COMMAND = getValue("commands.main_command", "legendaryguild");
        COMMAND_ALIASES = getValue("commands.aliases", Arrays.asList("lguild", "guild", "guilds", "lg"));

        // 验证指令配置
        if (COMMAND_ALIASES == null) {
            COMMAND_ALIASES = Arrays.asList("lguild", "guild", "guilds", "lg");
        }
